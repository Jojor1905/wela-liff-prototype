...
export function BottomActionBar({ label = "Continue", onClick, disabled, secondaryLabel, onSecondary }: { label?: string; onClick: () => void; disabled?: boolean; secondaryLabel?: string; onSecondary?: () => void }) {
  return (
